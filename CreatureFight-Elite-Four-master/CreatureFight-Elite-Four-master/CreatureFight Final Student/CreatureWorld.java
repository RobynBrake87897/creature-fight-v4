 ...
 * Date Last Modified: january 10th
 */
    ...
    public void act()
    {
        ...
        if( playerOneMenusAdded == false )
        {
            ...
            if(playerOneCreature == "Charmander")
            {
                ...
                oneFightMenu = oneFightMenu;
                oneSwitchMenu = oneSwitchMenu;
            }
